...
/**
 * D
 * Diseña el tablero de records para mandarsela a la clase Jugador y este pueda proyectarsela al usuario. 
 * 
 * 
 */
public class Jug extends Actor
{
     ...
     */
    /**
     * Coloca la imagen de fondo de la parte de los records y los parámetros de altura y ancho son para colocar la imagen en el mundo.
     */
    public Jug(int width, int height)
    {    
    ...
    /**
     * Método que se encarga de dibujar las cadenas.
     */
    ...
    /**
     * Proyecta el nombre del jugador y el puntaje respectivo.
     */
    private void drawScores()
    {
        ...
        drawString("TODOS ", 100, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);
        drawString("GANADORES", 100 + getImage().getWidth() / 2, topSpace - HEADER_TEXT_HEIGHT - 5, MAIN_COLOR, HEADER_TEXT_HEIGHT);        
